...
//print "P<br>";
	...
	$nombredelimail = $vgpathdocs.$_SESSION["vg_idc"]."/".$_POST["padre"]."/".$_SESSION["vg_idc"]."_".$a."_".$file_name;
	//print $nombredelimail;
	//exit;

	$nombredelimailBD = $_SESSION["vg_idc"]."/".$_POST["padre"]."/".$_SESSION["vg_idc"]."_".$a."_".$file_name;
...
//if ($visiblecliente == 1) mail($emailcliente,"Carga doc  ",$msg,$encabezados);
	...
	header("Location: navegam.php?idc=".$_SESSION["vg_idc"]."&padre=".$_POST["padre"]);
