...
$query = "insert into documentos set  idcliente = '".$_POST["idc"]."', fecha = now(), nombre = '".$file_name."', adjunto = '".$nombredelimailBD."', padre = ".$_POST["padre"].", tipo = '".$tipodoc."', tamano = '".$vltamano ."'";
