...
$consulta= "select * from usuarioscliente where iduc = ".$_REQUEST["idcb"];
          ...
          <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal adminex-form" id="signupForm4" method="post" action="guardar_clientesusu.php">
